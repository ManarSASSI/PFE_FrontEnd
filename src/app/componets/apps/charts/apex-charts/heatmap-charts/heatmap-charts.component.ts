...
@Component({
  ...
  standalone: true,
  imports: [MatCommonModule,NgApexchartsModule,SharedModule],
...
export class HeatmapChartsComponent {
  ...
  constructor() {
    ...
    this.chartOptions1 = {
      ...
      colors: ["#3366ff", "#F27036", "#663F59", "#6A6E94", "#4E88B4", "#00A7C6", "#18D8D8", '#A9D794', '#46AF78', '#A93F55', '#8C5E58', '#2176FF', '#33A1FD', '#7A918D', '#BAFF29'],
      xaxis: {
        type: 'category',
        categories: [
          '10:00',
