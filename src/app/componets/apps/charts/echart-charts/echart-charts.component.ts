...
import { CoolTheme, data } from './echarts';
import * as echarts from 'echarts';
@Component({
  selector: 'app-echart-charts',
  standalone: true,
  imports: [MatCommonModule, SharedModule, NgxEchartsModule],
  providers: [
    {
...
export class EchartChartsComponent {
    ...
    series: [
      {
        ...
        type: 'line',
        stack: 'counts',
        data: [150, 230, 220, 210, 130, 150, 270],
      },
    ],
    color: '#3366ff',
  };
    ...
    series: [
      {
        ...
        smooth: true,
        stack: 'counts',
        data: [850, 910, 890, 820, 1300, 1320, 1350],
      },
    ],
    color: '#3366ff',
  };
    ...
    series: [
      {
        ...
        stack: 'counts',
        areaStyle: {},
        data: [850, 900, 900, 930, 1250, 1260, 1270],
      },
    ],
    color: '#3366ff',
  };
  options4: EChartsOption = {
    ...
    color: ['#3366ff', '#fe7f00', '#f7b731', '#49b6f5', '#e82646'],
  };
  ...
  options12: EChartsOption = {
    ...
    dataset: {
      ...
      source: [
        ...
        ['Matcha Latte', 43.3, 85.8, 93.7, 42.4],
        ['Milk Tea', 83.1, 73.4, 55.1, 42.2],
        ['Cheese Cocoa', 86.4, 65.2, 82.5, 42.1],
        ['Walnut Brownie', 72.4, 53.9, 39.1, 42.1],
      ],
    },
  ...
  options15: EChartsOption = {
    ...
    color: ['#3366ff', '#fe7f00', '#f5b849', '#e6533c', '#49b6f5'],
  };
  theme!: string | ThemeOption;
  coolTheme = CoolTheme;
  options16: EChartsOption = {
    tooltip: {
      trigger: 'item',
    },
    legend: {
  ...
  getVirtualData(year: string) {
    ...
    for (var time = date; time < end; time += dayTime) {
      data.push([
        echarts.time.format('yyyy-MM-dd', time.toString(), false), // Convert time to string
  ...
  labelSetting: echarts.PictorialBarSeriesOption['label'] = {
    show: true,
    position: 'right',
    offset: [10, 0],
    fontSize: 16,
      ...
      series: [
        {
          ...
          data: [
            {
              value: 157,
              symbol: symbol || this.pathSymbols?.reindeer,
            },
            {
              value: 21,
              symbol: symbol || this.pathSymbols?.ship,
            },
            {
              value: 66,
              symbol: symbol || this.pathSymbols?.plane,
            },
            {
              value: 78,
              symbol: symbol || this.pathSymbols?.train,
            },
            {
              value: 123,
              symbol: symbol || this.pathSymbols?.car,
            },
          ],
        },
        {
